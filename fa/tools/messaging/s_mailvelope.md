...
** درسی برای خواندن: [محافظت از فایل ها](umbrella://information/protecting-files)، [ایمیل](umbrella://communications/email) **
** سطح: ** پیشرفته
...
- یک عبارت عبور قوی برای محافظت از کلید خصوصی خود انتخاب کنید. (چگونگی ایجاد رمزعبور قوی را در [رمز عبور](umbrella://information/passwords/beginner)یاد بگیرید.)
